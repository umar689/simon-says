...
// // Audio elements for game sounds
// const buttonSound = new Audio("mixkit-game-level-music-689.wav"); // Button sound
// const gameOverSound = new Audio("mixkit-player-losing-or-failing-2042.wav"); // Game-over sound
...
//             game = [];
//         }
//         if (game[game.length - 1] !== original[game.length - 1] && start) {
//             buttonSound.pause(); // Stop looping button sound
//             buttonSound.currentTime = 0; // Reset to start for next game
//             let body = document.querySelector("body");
//             body.setAttribute("class", "one");
...
//                 body.setAttribute("class", "none");
//             }, 250);
//             p.innerHTML = `GAME OVER! Your score was ${level - 1}.<br>Tap Start or press any key to restart`;
//             start = false;
//             original = [];
//             game = [];
//             if (hs < level) {
